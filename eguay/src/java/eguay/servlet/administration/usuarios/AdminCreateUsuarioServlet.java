 ...
 * @author carlos
 */
@WebServlet(name = "AdminCreateUsuarioServlet", urlPatterns = {"/Admin/Usuarios/SubmitCreate"})
public class AdminCreateUsuarioServlet extends AdminServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            as.createUser(user);
            response.sendRedirect(request.getContextPath() + "/Admin/Usuarios?msg=usuario+" + user.getUsername() + "+creado+correctamente");
